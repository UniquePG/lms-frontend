...
const Footer = () => {
    ...
    return (
        <footer className="bg-[#3498db] text-white py-6 relative left-0 bottom-0 px-3 shadow-[0_0_10px_-1px_black]">
          <div className="container mx-auto max-w-[90vw] flex flex-col lg:flex-row justify-between items-center">
            <div className="order-2 lg:order-1 mb-4 lg:mb-0">
              ...
              <p className="text-gray-700">Unlocking Knowledge, Empowering Minds</p>
            </div>
            <div className="order-1 lg:order-2 mb-4 lg:mb-0">
              <ul className="flex space-x-6 font-semibold">
                <li>
                  <a href="/" className="text-white hover:text-gray-700 transition duration-300">Home</a>
                </li>
                <li>
                  <a href="/courses" className="text-white hover:text-gray-700 transition duration-300">Courses</a>
                </li>
                <li>
                  <a href="/about" className="text-white hover:text-gray-700 transition duration-300">About Us</a>
                </li>
                <li>
                  <a href="contact" className="text-white hover:text-gray-800 transition duration-300">Contact Us</a>
                </li>
              </ul>
            </div>
          ...
          <div className="text-left m-auto text-gray-700 mt-4 max-w-[90vw]">
